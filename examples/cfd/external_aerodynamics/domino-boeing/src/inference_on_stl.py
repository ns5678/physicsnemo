...
if __name__ == "__main__":
    ...
    print('dirnames_per_gpu ', dirnames_per_gpu)

    domino = dominoInference(cfg, dist, False)
    domino.initialize_model(
        model_path="/lustre/snidhan/gtc-dc-demo-2025/physicsnemo/examples/cfd/external_aerodynamics/domino_luminary_cloud/src/outputs/LC_Dataset_No_Integral_Loss/1/models/DoMINO.0.499.pt"

...
if __name__ == "__main__":
    ...
    for count, dirname in enumerate(dirnames_per_gpu):
        ...
        vtp_out_path = (
            f"/lustre/snidhan/gtc-dc-demo-2025/lc-data/inferred-nim/infer_{dirname}.vtp"
        )
        vtu_out_path = (
            f"/lustre/snidhan/gtc-dc-demo-2025/lc-data/inferred-nim/infer_{dirname}.vtu"
        )
        ...
        volume_fields_predicted = (
            torch.cat((out_dict["pressure"], out_dict["velocity"]), axis=-1)[0]
            .cpu()
            .numpy()
        )
